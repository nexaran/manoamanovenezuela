...
export const FloatingEditorBar: React.FC<FloatingEditorBarProps> = ({ onOpenDriveSync, onOpenDonationsDashboard }) => {
  ...
  const handleSyncToProject = async () => {
    try {
      ...
      if (res.success) {
        triggerToast('🚀 ¡Excelente! Tus logos, galería, vehículos y metas han sido fijados en el servidor. La versión móvil y web pública mostrarán exactamente las mismas fotos definitivas.');
      } else {
