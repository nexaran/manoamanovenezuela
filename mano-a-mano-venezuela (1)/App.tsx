      ...
      <div className="container mx-auto px-6 lg:px-12 flex justify-between items-center">
        ...
        <div className="hidden md:flex items-center gap-1 lg:gap-2 font-medium text-stone-600 transition-colors">
          ...
          <button 
            ...
            className="relative overflow-hidden ml-1 inline-flex items-center gap-2 px-4 py-2 lg:px-5 lg:py-2 bg-gradient-to-r from-brand-accent via-[#d61858] to-brand-accent hover:brightness-110 text-white rounded-full text-xs lg:text-sm font-bold tracking-wide transition-all duration-200 border border-white/40 whitespace-nowrap cursor-pointer anim-vibrate-glow active:scale-95 group"
            id="btn-nav-financia-proyecto"
          >
            {/* Destello de brillo deslizante continuo */}
            <span 
              className="absolute inset-0 w-1/2 h-full bg-gradient-to-r from-transparent via-white/50 to-transparent pointer-events-none anim-shine"
              aria-hidden="true"
            />
            <span className="relative z-10 font-bold drop-shadow-sm">Financia nuestro proyecto</span>
            <Heart size={15} fill="currentColor" className="relative z-10 opacity-100 text-white animate-pulse" />
          </button>
        </div>
        ...
        {menuOpen && (
          <div className="fixed inset-0 bg-white z-40 flex flex-col items-center justify-center gap-3.5 animate-fade-in p-6 text-center overflow-y-auto">
            ...
            <button 
              ...
              className="relative overflow-hidden px-8 py-3 bg-gradient-to-r from-brand-accent via-[#d61858] to-brand-accent text-white rounded-full shadow-lg flex items-center gap-2 text-base font-bold mt-1 transition-all cursor-pointer anim-vibrate-glow border border-white/40"
            >
              <span 
                className="absolute inset-0 w-1/2 h-full bg-gradient-to-r from-transparent via-white/50 to-transparent pointer-events-none anim-shine"
                aria-hidden="true"
              />
              <span className="relative z-10 font-bold drop-shadow-sm">Financia nuestro proyecto</span>
              <Heart size={18} fill="currentColor" className="relative z-10 animate-pulse text-white" />
            </button>
...
function MainContent() {
  ...
  const OFFICIAL_TARGET_AMOUNT = 28000;
            ...
            <FadeIn delay={0.2} className="h-full">
              <div id="proyecto-brigada-99hdd" className="scroll-mt-28 bg-brand-dark p-6 md:p-10 lg:p-12 rounded-3xl shadow-soft h-full flex flex-col text-white">
                ...
                <button 
                  ...
                  className="relative overflow-hidden inline-flex items-center justify-center gap-2 px-5 py-3 md:px-6 md:py-4 bg-gradient-to-r from-brand-accent via-[#d61858] to-brand-accent hover:brightness-110 text-white rounded-xl font-bold text-sm md:text-base cursor-pointer shadow-lg active:scale-95 anim-vibrate-glow border border-white/40 group"
                ...
                >
                  ...
                  />
                  <span className="relative z-10 font-bold drop-shadow-sm">Financia nuestro proyecto</span>
                  <Heart size={16} fill="currentColor" className="relative z-10 text-white animate-pulse" />
                </button>
              </div>
            </FadeIn>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 lg:gap-10">
            {[
              { 
                ...
                source: "Globovisión", 
                image: "/globovision-entrevista.jpg",
                isFullCover: true,
                bg: "bg-gradient-to-br from-[#004b87] via-[#00386b] to-[#002447]",
                fallback: "https://img.youtube.com/vi/rjWcdHiT3Fk/maxresdefault.jpg",
              ...
              { 
                ...
                source: "La Tele Tuya", 
                image: "/tlt-entrevista.jpg",
                isFullCover: true,
                bg: "bg-gradient-to-br from-[#3b1560] via-[#240e3b] to-[#140624]",
                fallback: "https://img.youtube.com/vi/qpgKn--dGYM/sddefault.jpg",
              ...
              { 
                ...
                image: "/instagram-entrevista.jpg",
                isFullCover: true,
